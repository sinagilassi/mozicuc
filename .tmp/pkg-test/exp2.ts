...
console.log(`Available references: ${listReferences().join(', ')}\n`);
...
// Pressure
const pressure1 = convertFromTo(1, 'MPa', 'Pa');
console.log(`1 MPa = ${pressure1} Pa`);

const pressure2 = convertFromTo(100, 'bar', 'psi');
console.log(`100 bar = ${pressure2.toFixed(2)} psi`);

// Temperature
const temp1 = convertFromTo(358, 'K', 'C');
console.log(`358 K = ${temp1.toFixed(2)} °C`);

const temp2 = convertFromTo(25, 'C', 'K');
console.log(`25 °C = ${temp2.toFixed(2)} K`);

const temp3 = convertFromTo(32, 'F', 'C');
console.log(`32 °F = ${temp3} °C`);

// Mass
const mass = convertFromTo(10, 'kg', 'lb');
...
console.log(`1 MPa => Pa: ${to(1, 'MPa => Pa')}`);
console.log(`100 m => ft: ${to(100, 'm => ft').toFixed(2)}`);
console.log(`1000 W => HP: ${to(1000, 'W => HP').toFixed(4)}`);
console.log(`5 mi => km: ${to(5, 'mi => km').toFixed(2)}`);
console.log(`212 F => C: ${to(212, 'F => C')}\n`);
...
const pressureUnits = checkReference('PRESSURE', false);
...
const tempUnits = checkReference('TEMPERATURE', false);
console.log('\nTemperature units:');
...
values.forEach(val => {
    const result = convert(val, 'bar', 'psi');
